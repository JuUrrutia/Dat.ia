...
api_router.include_router(llm_diagnostic_router, prefix="/llm", tags=["Motor LLM Local"])
api_router.include_router(admin_catalog_router, prefix="", tags=["Catálogo, Conectores e Informes"])
